...
import 'package:mejor_en_bici/Return.dart';
        ...
        child: Column(   
          children: [
            InkWell(
              ...
              child: containerOptions("Request", "availability", "https://i.pinimg.com/564x/6e/a3/48/6ea348a4ec23bf02d6b74527476e7f4e.jpg"),
            ),
            InkWell(
              onTap: (){
                Navigator.push(
